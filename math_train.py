"""
Copied from:
https://github.com/willccbb/verifiers/blob/bbe5184d6d4cd43114814459b5b13c509f640141/verifiers/examples/math_train.py

With the vllm host overridden.
"""
...
parser.add_argument(
    ...
    type=str,
    default="0.0.0.0",
    help="Host for the vLLM server. Replace with your inference server's host for multi-node setups",
)
...
training_args = GRPOConfig(
    ...
    use_vllm=True,
    vllm_server_host=args.vllm_server_host,  # replace with your inference server's host for multi-node setups
